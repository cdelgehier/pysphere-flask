...
def root():
	html =  """<html>
			...
			<li><p>/api/v1/monitor/properties&nbsp;<a href='/api/v1/monitor/properties?vm_name=hortonbox'>VM Properties (exhaustive list)</a>&nbsp;(GET,&nbsp;POST)</p>
			<p>@param vm_name - The VM name</p></li>
			<li><p>/api/v1/monitor/property&nbsp;<a href='/api/v1/monitor/property?vm_name=hortonbox&property=ip_address'>VM Property</a>&nbsp;(GET,&nbsp;POST)</p>
			...
			<li>mac_address</li>
			<li>net</li></ul></li>
			<li><p>/api/v1/monitor/status&nbsp;<a href='/api/v1/monitor/status?vm_name=hortonbox'>VM Status</a>&nbsp;(GET,&nbsp;POST)</p>
			...
			<li><p>/api/v1/monitor/resource_pool_name&nbsp;<a href='/api/v1/monitor/resource_pool_name?vm_name=hortonbox'>VM Resource Pool Name</a>&nbsp;(GET,&nbsp;POST)</p>
			<p>@param vm_name - The VM name</p></li>
			</ol>
		</html>"""
	return html 
